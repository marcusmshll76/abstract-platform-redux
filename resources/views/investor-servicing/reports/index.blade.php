                ...
                <form>
                    <div class="row middle-xs">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="row center-xs">
                                <div class="col-xs-12 col-md-8">
                                    <p class="no-margin-top">You can choose a date at least 2 days after you upload your quarterly report. Abstract will email this defined quarterly report to ALL posiitions tied to the deal.</p><input type="text" id="datepicker">
                                </div>
                            </div>
                        </div>
                        <div class="row"></div>
